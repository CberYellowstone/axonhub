...
type RequestExecution struct {
	...
	AttemptType requestexecution.AttemptType `json:"attempt_type,omitempty"`
...
func (*RequestExecution) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case requestexecution.FieldExternalID, requestexecution.FieldModelID, requestexecution.FieldFormat, requestexecution.FieldAttemptType, requestexecution.FieldErrorMessage, requestexecution.FieldStatus, requestexecution.FieldRequestURL:
	...
	for i := range columns {
		...
		case requestexecution.FieldAttemptType:
			if value, ok := values[i].(*sql.NullString); !ok {
				...
				_m.AttemptType = requestexecution.AttemptType(value.String)
			}
...
func (_m *RequestExecution) String() string {
	...
	builder.WriteString(fmt.Sprintf("%v", _m.AttemptType))
	builder.WriteString(", ")
